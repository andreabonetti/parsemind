...
if __name__ == "__main__":
    ...
    Each bullet point reports the reference author, padding space, the title, the complete list of authors, and additional information.
    Remove the complete list of authors and the additional information **after** the title of each bullet point.
    Keep reference author, padding space, and the title, as they are now.
